...
impl FungibleTokenCore for FungibleToken {
    ...
    fn ft_transfer(
        ...
        assert_one_yocto();
        if sender_id == None {
            sender_id = Some(ValidAccountId::try_from(env::predecessor_account_id()).unwrap());
        };
    ...
    fn ft_transfer_from(
        ...
        assert_one_yocto();
        // if ValidAccountId::try_from(env::predecessor_account_id()).unwrap() != sender_id {
        if ValidAccountId::try_from(env::signer_account_id()).unwrap() != sender_id {
            assert!(
                self.get_allowance(sender_id.clone().into(), env::predecessor_account_id())
                    > amount.into(),
        ...
        self.allowances.insert(
            &(sender_id.into(), env::predecessor_account_id()),
